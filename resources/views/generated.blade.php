            ...
            <div class="type_box my-2">
                ...
                <div class="details">
                    ...
                    <div class="d-flex align-items-center mb-2 pro">
                        ...
                        <span
                            class="font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'mr-1 ml-md-2 ml-1 pr-md-2 pr-sm-1 pl-md-2 pl-sm-1' : 'ml-1 mr-md-2 mr-1 pl-md-2 pl-sm-1 pr-md-2 pr-sm-1'}}">{{$overallRating[1]}} {{('Reviews')}}</span>
                        <span style="width: 0px;height: 10px;border: 0.5px solid #707070; margin-top: 6px"></span>
                        <span
                            class="font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'mr-1 ml-md-2 ml-1 pr-md-2 pr-sm-1 pl-md-2 pl-sm-1' : 'ml-1 mr-md-2 mr-1 pl-md-2 pl-sm-1 pr-md-2 pr-sm-1'}}">{{$countOrder}} {{('orders')}}   </span>
                        <span style="width: 0px;height: 10px;border: 0.5px solid #707070; margin-top: 6px">    </span>
                        <span
                            class=" font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'mr-1 ml-md-2 ml-0 pr-md-2 pr-sm-1 pl-md-2 pl-sm-1' : 'ml-1 mr-md-2 mr-0 pl-md-2 pl-sm-1 pr-md-2 pr-sm-1'}}">  {{$countWishlist}} {{('wish')}} </span>
                    </div>
                    <div class="mb-3">
                        <span
                        ...
                        <input type="hidden" name="id" value="{{ $product->id }}">
                            @if (count(json_decode($product->colors)) > 0)
                                <div class="row flex-column flex-start">
                                    <div class="product-description-label">{{'color'}}:
                                    </div>
                                    <div>
                    ...
                    <!-- Quantity + Add to cart -->
                        <div class="row no-gutters">
                            <div class="col-4 d-flex align-items-center">
                                <strong class="product-description-label">{{('Quantity')}}:</strong>
                            </div>
                        ...
                        <div class="row flex-start no-gutters d-none mt-2" id="chosen_price_div">
                            <div class="{{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}">
                                <div class="product-description-label">{{('total_price')}}:</div>
                            </div>
                            <div>
                            ...
                            <div class="col-12">
                                @if($product['current_stock']<=0)
                                    <h5 class="mt-3" style="color: red">{{('out_of_stock')}}</h5>
                                @endif
                            </div>
                        </div>
                        ...
                        {{-- <div class="d-flex justify-content-between mt-2">
                            <button
                                ...
                                <span class="string-limit">{{('buy_now')}}</span>
                            </button>
                            <button
                                ...
                                type="button"
                                style="width:37%; height: 45px">
                                <span class="string-limit">{{('add_to_cart')}}</span>
                            </button>
